...
namespace TCC_Backend.Infrastructure.Validators.Servico.Post
{
    public class ServicoValidator : AbstractValidator<PostServicoRequest>
    {
        public ServicoValidator()
        {
            ...
            RuleFor(s => s.Imagem)
                .NotEmpty().WithMessage("A imagem representante do serviço é obrigatório.");
